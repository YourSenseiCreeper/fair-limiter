...
- **Configurable warnings** — choose 1 to 15 minutes before the daily limit ends; if saved time is available, receive a notification when it starts and another warning before it runs out
